...
urlpatterns = [
    ...
    path('at/', views.at_index, name='at_index'),
    path('nt/', views.nt_index, name='nt_index'),
    path('at/events/', views.ATEIndexView.as_view(), name='ate_index'),
    path('nt/events/', views.NTEIndexView.as_view(), name='nte_index'),
    path('at/sources/', views.ATSIndexView.as_view(), name='ats_index'),
    path('nt/sources/', views.NTSIndexView.as_view(), name='nts_index'),
    path('at/vulns/', views.VulnIndexView.as_view(), name='vuln_index'),
    path('nt/conds/', views.CondIndexView.as_view(), name='cond_index'),
    path('impacts/', views.ImpactIndexView.as_view(), name='impact_index'),
    path('responses/', views.ResponseIndexView.as_view(),
        name='response_index'),
    path('at/events/<int:pk>/', views.ATEDetailView.as_view(),
        name='ate_detail'),
    path('nt/events/<int:pk>/', views.NTEDetailView.as_view(),
        name='nte_detail'),
    path('at/sources/<int:pk>/', views.ATSDetailView.as_view(),
        name='ats_detail'),
    path('nt/sources/<int:pk>/', views.NTSDetailView.as_view(),
        name='nts_detail'),
    path('at/vulns/<int:pk>/', views.VulnDetailView.as_view(),
        name='vuln_detail'),
    path('nt/conds/<int:pk>/', views.CondDetailView.as_view(),
        name='cond_detail'),
    path('impacts/<int:pk>/', views.ImpactDetailView.as_view(),
        name='impact_detail'),
    path('response/<int:pk>/', views.ResponseDetailView.as_view(),
